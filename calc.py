...
LARGE_FONT_STYLE = ("Komika Axis", 40, "bold")
SMALL_FONT_STYLE = ("Komika Axis", 16)
DIGITS_FONT_STYLE = ("Komika Axis", 24, "bold")
DEFAULT_FONT_STYLE = ("Komika Axis", 20)
